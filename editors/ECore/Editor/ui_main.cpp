...
void TUI::Redraw()
{
    ...
    try{
        ...
        if (Device.Begin()){
		    ...
		    //	ELog.Msg(mtError, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type B]");
            }
		    ...
		    //	ELog.Msg(mtError, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type C]");
            }
        }
    	Device.Statistic->RenderDUMP_RT.End();
    }catch(...){
//    	ELog.Msg(mtError, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type A]");
//		_clear87();
//		FPU::m24r();
